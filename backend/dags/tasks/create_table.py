...
client.command('''CREATE TABLE IF NOT EXISTS blocktrade_track.users (
...
client.command('''CREATE TABLE IF NOT EXISTS blocktrade_track.portfolio (
...
client.command('''CREATE TABLE IF NOT EXISTS blocktrade_track.transactions (
...
''')
client.command('''CREATE TABLE IF NOT EXISTS blocktrade_track.password_reset_tokens (
    user_id String,
...
client.command('''CREATE TABLE IF NOT EXISTS blocktrade_track.news(
