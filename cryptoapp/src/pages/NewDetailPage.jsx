...
const NewDetailPage = () => {
  return (
    <div className='bg-transparent relative'>
        <div className='bg-custom-radial h-[656px] '>
        </div>
        <div className='bg-white flex justify-center items-center '>
            <div className='pt-16 max-w-[1046px]  bg-white -mt-[500px] w-full px-[120px] pb-[59px] mx-auto'>
                <div className='flex text-[#001b3c]'>
                    <span>3D AGO</span>
